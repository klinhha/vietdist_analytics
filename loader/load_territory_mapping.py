...
terriory_mapping = pd.read_excel(r"/Users/hakhanhlinh/Unigap Python/DAC K46/VietDist_SampleData/SRC08_territory_mapping.xlsx")
print(terriory_mapping)
